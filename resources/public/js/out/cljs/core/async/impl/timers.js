...
var skip_list_node__3 = (function (k,v,level){var arr = (new Array((level + 1)));var i_13527 = 0;while(true){
if((i_13527 < arr.length))
{(arr[i_13527] = null);
{
...
{var i_13534 = (self__.level + 1);while(true){
if((i_13534 <= (new_level + 1)))
{(update[i_13534] = self__.header);
{
...
var coll = this;var update = (new Array(cljs.core.async.impl.timers.MAX_LEVEL));var x = cljs.core.async.impl.timers.least_greater_node.call(null,self__.header,k,self__.level,update);var x__$1 = (x.forward[0]);if((!((x__$1 == null))) && ((x__$1.key === k)))
{var i_13536 = 0;while(true){
if((i_13536 <= self__.level))
{var links_13537 = (update[i_13536]).forward;if(((links_13537[i_13536]) === x__$1))
{(links_13537[i_13536] = (x__$1.forward[i_13536]));
{
