...
goog.require('cljs.core.async.impl.protocols');
cljs.core.async.impl.channels.box = (function box(val){if(typeof cljs.core.async.impl.channels.t13568 !== 'undefined')
{} else
{
/**
* @constructor
*/
cljs.core.async.impl.channels.t13568 = (function (val,box,meta13569){
this.val = val;
this.box = box;
...
cljs.core.async.impl.channels.t13568.cljs$lang$type = true;
cljs.core.async.impl.channels.t13568.cljs$lang$ctorStr = "cljs.core.async.impl.channels/t13568";
cljs.core.async.impl.channels.t13568.cljs$lang$ctorPrWriter = (function (this__4010__auto__,writer__4011__auto__,opt__4012__auto__){return cljs.core._write.call(null,writer__4011__auto__,"cljs.core.async.impl.channels/t13568");
});
cljs.core.async.impl.channels.t13568.prototype.cljs$core$IDeref$_deref$arity$1 = (function (_){var self__ = this;
var ___$1 = this;return self__.val;
});
cljs.core.async.impl.channels.t13568.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_13570){var self__ = this;
var _13570__$1 = this;return self__.meta13569;
});
cljs.core.async.impl.channels.t13568.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_13570,meta13569__$1){var self__ = this;
var _13570__$1 = this;return (new cljs.core.async.impl.channels.t13568(self__.val,self__.box,meta13569__$1));
});
cljs.core.async.impl.channels.__GT_t13568 = (function __GT_t13568(val__$1,box__$1,meta13569){return (new cljs.core.async.impl.channels.t13568(val__$1,box__$1,meta13569));
});
}
return (new cljs.core.async.impl.channels.t13568(val,box,null));
});
...
{self__.closed = true;
while(true){
var taker_13571 = self__.takes.pop();if((taker_13571 == null))
{} else
{if(cljs.core.async.impl.protocols.active_QMARK_.call(null,taker_13571))
{var take_cb_13572 = cljs.core.async.impl.protocols.commit.call(null,taker_13571);cljs.core.async.impl.dispatch.run.call(null,((function (take_cb_13572,taker_13571){
return (function (){return take_cb_13572.call(null,null);
});})(take_cb_13572,taker_13571))
);
} else
{}
{
