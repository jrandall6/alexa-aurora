...
cljs.core.async.impl.dispatch.queued_QMARK_ = false;
var count_13562 = 0;while(true){
var m_13563 = cljs.core.async.impl.dispatch.tasks.pop();if((m_13563 == null))
{} else
{m_13563.call(null);
if((count_13562 < cljs.core.async.impl.dispatch.TASK_BATCH_SIZE))
{{
var G__13564 = (count_13562 + 1);
count_13562 = G__13564;
continue;
}
} else
{}
