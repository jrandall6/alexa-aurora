...
{{
var G__10692 = cljs.core.pop.call(null,v__$1);
v__$1 = G__10692;
continue;
}
} else
...
{var pred__10696 = cljs.core._EQ_;var expr__10697 = limit;if(cljs.core.truth_(pred__10696.call(null,1,expr__10697)))
{return (new cljs.core.PersistentVector(null,1,5,cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__10696.call(null,2,expr__10697)))
...
var G__10699 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__10700 = (limit__$1 - 1);
var G__10701 = cljs.core.conj.call(null,parts,s__$1.substring(0,index));
s__$1 = G__10699;
limit__$1 = G__10700;
parts = G__10701;
continue;
...
{var ch = s.charAt(index);var temp__4090__auto___10703 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4090__auto___10703))
{var replacement_10704 = temp__4090__auto___10703;buffer.append([cljs.core.str(replacement_10704)].join(''));
} else
{buffer.append(ch);
}
{
